document.getElementById("bill-btn").addEventListener("click", function (e) {
    ...
    const amount = parseFloat(document.querySelector("#pay-bill-form #amount").value);
    const pin = document.querySelector("#pay-bill-form #pin").value;
    ...
    addTransaction("Pay Bill", amount);
});